// RUN: mlir-loop-legacy  %s --no-alias --arch x86-64 --cpu tigerlake --print-assembly --hide-jumps 2>&1 | filecheck %s
...
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm19,%zmm0
...
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm19,%zmm1
...
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm17,%zmm12
...
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm16,%zmm2
...
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm21,%zmm0
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm19,%zmm3
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm18,%zmm13
// CHECK-NEXT:  	vbroadcastss -0xff4(%rdi,%r11,4),%zmm20
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm17,%zmm10
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm21,%zmm1
// CHECK-NEXT:  	vfmadd231ps %zmm20,%zmm19,%zmm4
...
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm17,%zmm12
...
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm21,%zmm10
...
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm21,%zmm11
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm20,%zmm14
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm19,%zmm4
...
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm16,%zmm0
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm20,%zmm3
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm19,%zmm13
...
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm19,%zmm14
...
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm17,%zmm12
...
// CHECK-NEXT:  	vfmadd231ps %zmm17,%zmm21,%zmm10
// CHECK-NEXT:  	vfmadd231ps %zmm17,%zmm20,%zmm13
// CHECK-NEXT:  	vfmadd231ps %zmm17,%zmm19,%zmm3
// CHECK-NEXT:  	vbroadcastss -0xfe8(%rdi,%r11,4),%zmm18
// CHECK-NEXT:  	vfmadd231ps %zmm17,%zmm16,%zmm0
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm21,%zmm11
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm20,%zmm14
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm19,%zmm4
...
// CHECK-NEXT:  	vfmadd231ps %zmm17,%zmm16,%zmm2
...
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm21,%zmm0
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm20,%zmm3
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm19,%zmm13
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm18,%zmm10
// CHECK-NEXT:  	vbroadcastss -0xfe4(%rdi,%r11,4),%zmm16
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm21,%zmm1
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm20,%zmm4
// CHECK-NEXT:  	vfmadd231ps %zmm16,%zmm19,%zmm14
...
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm16,%zmm10
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm20,%zmm13
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm19,%zmm3
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm17,%zmm0
// CHECK-NEXT:  	vbroadcastss -0xfe0(%rdi,%r11,4),%zmm18
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm16,%zmm11
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm20,%zmm14
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm19,%zmm4
...
// CHECK-NEXT:  	vfmadd231ps %zmm18,%zmm17,%zmm2
