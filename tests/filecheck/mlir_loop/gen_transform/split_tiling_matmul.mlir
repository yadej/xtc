...
// CHECK-NEXT:      transform.annotate %loops "__node0__/I[1]/I" : !transform.any_op
...
// CHECK-NEXT:      transform.annotate %loops_3 "__node0__/I[1]/K" : !transform.any_op
...
// CHECK-NEXT:      %3 = transform.get_parent_op %first {isolated_from_above} : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      transform.yield 
// CHECK-NEXT:    }
// CHECK-NEXT:  }
