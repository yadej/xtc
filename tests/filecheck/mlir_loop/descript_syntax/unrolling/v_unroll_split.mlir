...
// CHECK-NEXT:      transform.annotate %loops_1 "__node0__/k[0]/j" : !transform.any_op
...
// CHECK-NEXT:      transform.loop.unroll %loops_1 {factor = 256 : i64} : !transform.any_op
// CHECK-NEXT:      %tiled_linalg_op_2, %loops_3 = transform.structured.tile_using_for %second tile_sizes [0, 1, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
// CHECK-NEXT:      transform.annotate %loops_3 "__node0__/k[1]/j" : !transform.any_op
