...
// CHECK-NEXT:      transform.annotate %loops_3 "__node0__/k[0]/k0" : !transform.any_op
...
// CHECK-NEXT:      transform.annotate %loops_5 "__node0__/k[0]/j0" : !transform.any_op
// CHECK-NEXT:      %1 = transform.get_parent_op %loops_3 {isolated_from_above} : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      %tiled_linalg_op_6, %loops_7 = transform.structured.tile_using_for %second tile_sizes [0, 0, 1] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
// CHECK-NEXT:      transform.annotate %loops_7 "__node0__/k[1]/k0" : !transform.any_op
