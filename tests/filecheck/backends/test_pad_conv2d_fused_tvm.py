...
# CHECK-NEXT:              for r, s, c in T.grid(5, 5, 3):
# CHECK-NEXT:                  cse_var_2: T.int32 = h * 64 + w * 16
# CHECK-NEXT:                  _1_1 = T.Buffer((1200,), data=_1.data)
# CHECK-NEXT:                  conv_1[cse_var_2:cse_var_2 + 16] = conv_1[cse_var_2:cse_var_2 + 16] + T.Broadcast(pad_1[h * 66 + r * 33 + w * 6 + s * 3 + c], 16) * _1_1[r * 240 + s * 48 + c * 16:r * 240 + s * 48 + c * 16 + 16]
# CHECK-NEXT:  CODE: 0
