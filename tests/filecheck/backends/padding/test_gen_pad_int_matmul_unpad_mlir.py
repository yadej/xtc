...
# CHECK-NEXT:      %subview_6 = memref.subview %alloca_3[2, 2] [14, 14] [1, 1] : memref<18x18xf32> to memref<14x14xf32, strided<[18, 1], offset: 38>>
# CHECK-NEXT:      linalg.copy {__xtc_id_C_} ins(%subview_6 : memref<14x14xf32, strided<[18, 1], offset: 38>>) outs(%arg2 : memref<14x14xf32>)
# CHECK-NEXT:      return
# CHECK-NEXT:    }
...
# CHECK-NEXT:        %subview_27 = memref.subview %alloca[%arg3, 0] [1, 18] [1, 1] : memref<18x18xf32> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %c0_28 = arith.constant 0 : index
# CHECK-NEXT:        %c18_29 = arith.constant 18 : index
# CHECK-NEXT:        %c1_30 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_28 to %c18_29 step %c1_30 {
# CHECK-NEXT:          %subview_31 = memref.subview %subview_27[0, %arg4] [1, 1] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          linalg.fill {__xtc_id_A_pad_0_} ins(%cst : f32) outs(%subview_31 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
# CHECK-NEXT:      %subview = memref.subview %alloca[2, 2] [14, 14] [1, 1] : memref<18x18xf32> to memref<14x14xf32, strided<[18, 1], offset: 38>>
...
# CHECK-NEXT:        %subview_28 = memref.subview %subview[%arg3, 0] [1, 14] [1, 1] : memref<14x14xf32, strided<[18, 1], offset: 38>> to memref<1x14xf32, strided<[18, 1], offset: ?>>
...
# CHECK-NEXT:          %subview_33 = memref.subview %subview_28[0, %arg4] [1, 1] [1, 1] : memref<1x14xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          linalg.copy {__xtc_id_A_pad_} ins(%subview_32 : memref<1x1xf32, strided<[14, 1], offset: ?>>) outs(%subview_33 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
...
# CHECK-NEXT:        %subview_27 = memref.subview %alloca_2[%arg3, 0] [1, 18] [1, 1] : memref<18x18xf32> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %c0_28 = arith.constant 0 : index
# CHECK-NEXT:        %c18_29 = arith.constant 18 : index
# CHECK-NEXT:        %c1_30 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_28 to %c18_29 step %c1_30 {
# CHECK-NEXT:          %subview_31 = memref.subview %subview_27[0, %arg4] [1, 1] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          linalg.fill {__xtc_id_B_pad_0_} ins(%cst_3 : f32) outs(%subview_31 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
...
# CHECK-NEXT:        %subview_28 = memref.subview %subview_7[%arg3, 0] [1, 14] [1, 1] : memref<14x14xf32, strided<[18, 1], offset: 38>> to memref<1x14xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %c0_29 = arith.constant 0 : index
# CHECK-NEXT:        %c14_30 = arith.constant 14 : index
# CHECK-NEXT:        %c1_31 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_29 to %c14_30 step %c1_31 {
# CHECK-NEXT:          %subview_32 = memref.subview %subview_27[0, %arg4] [1, 1] [1, 1] : memref<1x14xf32, strided<[14, 1], offset: ?>> to memref<1x1xf32, strided<[14, 1], offset: ?>>
# CHECK-NEXT:          %subview_33 = memref.subview %subview_28[0, %arg4] [1, 1] [1, 1] : memref<1x14xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          linalg.copy {__xtc_id_B_pad_} ins(%subview_32 : memref<1x1xf32, strided<[14, 1], offset: ?>>) outs(%subview_33 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
...
# CHECK-NEXT:        %subview_27 = memref.subview %alloca_11[%arg3, 0] [1, 18] [1, 1] : memref<18x18xf32> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %c0_28 = arith.constant 0 : index
# CHECK-NEXT:        %c18_29 = arith.constant 18 : index
# CHECK-NEXT:        %c1_30 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_28 to %c18_29 step %c1_30 {
# CHECK-NEXT:          %subview_31 = memref.subview %subview_27[0, %arg4] [1, 1] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          linalg.fill {__xtc_id_matmul_padded_0_} ins(%cst_12 : f32) outs(%subview_31 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:        } {"./j"}
# CHECK-NEXT:      } {"./i"}
...
# CHECK-NEXT:        %subview_27 = memref.subview %alloca[%arg3, 0] [1, 18] [1, 1] : memref<18x18xf32> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %subview_28 = memref.subview %alloca_2[0, 0] [18, 18] [1, 1] : memref<18x18xf32> to memref<18x18xf32, strided<[18, 1]>>
# CHECK-NEXT:        %subview_29 = memref.subview %alloca_11[%arg3, 0] [1, 18] [1, 1] : memref<18x18xf32> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %c0_30 = arith.constant 0 : index
# CHECK-NEXT:        %c18_31 = arith.constant 18 : index
# CHECK-NEXT:        %c1_32 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_30 to %c18_31 step %c1_32 {
# CHECK-NEXT:          %subview_33 = memref.subview %subview_27[0, 0] [1, 18] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x18xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          %subview_34 = memref.subview %subview_28[0, %arg4] [18, 1] [1, 1] : memref<18x18xf32, strided<[18, 1]>> to memref<18x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          %subview_35 = memref.subview %subview_29[0, %arg4] [1, 1] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:          %c0_36 = arith.constant 0 : index
# CHECK-NEXT:          %c18_37 = arith.constant 18 : index
# CHECK-NEXT:          %c1_38 = arith.constant 1 : index
# CHECK-NEXT:          scf.for %arg5 = %c0_36 to %c18_37 step %c1_38 {
# CHECK-NEXT:            %subview_39 = memref.subview %subview_33[0, %arg5] [1, 1] [1, 1] : memref<1x18xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:            %subview_40 = memref.subview %subview_34[%arg5, 0] [1, 1] [1, 1] : memref<18x1xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:            %subview_41 = memref.subview %subview_35[0, 0] [1, 1] [1, 1] : memref<1x1xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:            linalg.matmul {__xtc_id_matmul_padded_} ins(%subview_39, %subview_40 : memref<1x1xf32, strided<[18, 1], offset: ?>>, memref<1x1xf32, strided<[18, 1], offset: ?>>) outs(%subview_41 : memref<1x1xf32, strided<[18, 1], offset: ?>>)
# CHECK-NEXT:          } {"./k"}
# CHECK-NEXT:        } {"./j"}
# CHECK-NEXT:      } {"./i"}
...
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
# CHECK-NEXT:      %subview_23 = memref.subview %alloca_11[2, 2] [14, 14] [1, 1] : memref<18x18xf32> to memref<14x14xf32, strided<[18, 1], offset: 38>>
...
# CHECK-NEXT:        %subview_27 = memref.subview %subview_23[%arg3, 0] [1, 14] [1, 1] : memref<14x14xf32, strided<[18, 1], offset: 38>> to memref<1x14xf32, strided<[18, 1], offset: ?>>
# CHECK-NEXT:        %subview_28 = memref.subview %arg2[%arg3, 0] [1, 14] [1, 1] : memref<14x14xf32> to memref<1x14xf32, strided<[14, 1], offset: ?>>
# CHECK-NEXT:        %c0_29 = arith.constant 0 : index
# CHECK-NEXT:        %c14_30 = arith.constant 14 : index
# CHECK-NEXT:        %c1_31 = arith.constant 1 : index
# CHECK-NEXT:        scf.for %arg4 = %c0_29 to %c14_30 step %c1_31 {
# CHECK-NEXT:          %subview_32 = memref.subview %subview_27[0, %arg4] [1, 1] [1, 1] : memref<1x14xf32, strided<[18, 1], offset: ?>> to memref<1x1xf32, strided<[18, 1], offset: ?>>
...
# CHECK-NEXT:          linalg.copy {__xtc_id_C_} ins(%subview_32 : memref<1x1xf32, strided<[18, 1], offset: ?>>) outs(%subview_33 : memref<1x1xf32, strided<[14, 1], offset: ?>>)
# CHECK-NEXT:        } {"./d1"}
# CHECK-NEXT:      } {"./d0"}
# CHECK-NEXT:      return
# CHECK-NEXT:    }
...
# CHECK-NEXT:    - %5: unpad2d(%4, padding=(2, 2, 2, 2), axis=(-2, -1)) {name = 'C'} : [18x18xfloat32] -> [14x14xfloat32]
# CHECK-NEXT:  
# CHECK-NEXT:  CODE: 0
