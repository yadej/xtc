...
// CHECK-NEXT:      %5 = transform.apply_registered_pass "convert-linalg-to-affine-loops" to %4 : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      %6 = transform.apply_registered_pass "affine-super-vectorize" to %5 {options = "virtual-vector-size=16"} : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      %7 = transform.apply_registered_pass "affine-super-vectorize" to %6 {options = "virtual-vector-size=8"} : (!transform.any_op) -> !transform.any_op
// CHECK-NEXT:      %8 = transform.apply_registered_pass "affine-super-vectorize" to %7 {options = "virtual-vector-size=4"} : (!transform.any_op) -> !transform.any_op
